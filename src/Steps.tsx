...
export const Step2 = (props: any) => {
    return (
        <div className="step step2">
            ...
            <div>
                <input type="text" pattern="[0-9]+" style={{width: "6rem"}} defaultValue={props.startNumber} min="1" max="99999" required onChange={(e) => props.changeStartNumber(e.target.value)} />
                からスタートで
