...
export const Step2 = (props: any) => {
    return (
        <div className="step step2">
            ...
            <div>
                <input type="number" style={{width: "6rem"}} defaultValue="10000" min="1" max="99999" required onChange={(e) => props.changeStartNumber(e.target.value)} />
                からスタートで
                <input type="number" style={{width: "4rem"}} defaultValue="1" min="1" max="100" required onChange={(e) => props.changeCountNumber(e.target.value)} />ページ
            </div>
